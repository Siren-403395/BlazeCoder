 ...
 *
 * agent-core depends ONLY on these interfaces (plus @blazecoder/shared types and
...
import type {
  ...
  ToolCall,
  TranscriptMessage,
} from "@blazecoder/shared";

// The conversation transcript + session shapes are FE↔BE contracts; they live in
// @blazecoder/shared and are re-exported here so the loop, store, and adapters
