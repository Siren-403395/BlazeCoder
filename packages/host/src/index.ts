/**
 * @zephyrcode/host — the Node/OS host wiring shared by every zephyrcode UI host
 ...
 *
 * A UI host depends on @zephyrcode/host (+ core + shared) and never on a sibling host,
